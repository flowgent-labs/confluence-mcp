...
```sh
# JSON body
./bin/confluence-mcp -v 1 -t cli uploadScanReport --scanId 12345 \
  --body '{"note":"quarterly"}'
```
...
# Named file field
./bin/confluence-mcp -v 1 -t cli configSaml \
...
```sh
git clone https://github.com/<YOUR_ORG>/confluence-mcp.git
cd confluence-mcp
make build
make test-ut
```
...
This generated MCP server project is licensed under the Apache License 2.0 —
see the [LICENSE](LICENSE) file for details.

The Apache-2.0 license is intentionally permissive for generated server
output: commercial use, internal enterprise deployment, modification,
redistribution, and proprietary integration are allowed subject to the Apache
License 2.0 terms. This generated project is not subject to mcpfather's AGPL
license obligations solely because it was generated by mcpfather.
