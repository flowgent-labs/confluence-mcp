...
- **GitHub Issues**: [Create an issue](https://github.com/<YOUR_ORG>/confluence-mcp/issues)
- **Discussions**: [Start a discussion](https://github.com/<YOUR_ORG>/confluence-mcp/discussions)
